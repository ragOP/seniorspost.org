...
const messages = [
  ...
  },
  {
    id: "initial-2",
    content:
      "Emily this side, and I've got great news about a special Auto Insurance Program that could save you serious cash! 💰",
    role: "assistant",
    delay: 800,
  },
  {
    id: "initial-3",
    content:
      "Want to see if you qualify for a Discounted Auto Insurance Program? It only takes 2 minutes! Tap 'Yes' to get started! 👇  ",
    role: "assistant",
    delay: 1000,
  },
];
    ...
    setTimeout(() => {
      setChat((prev) => [
        ...prev,
        {
          id: "assistant-6",
          content:
            "🎉 Fantastic news! You're one step closer to securing your Discounted Auto Insurance Plan",
          role: "assistant",
        },
      ]);
    }, 1000);
    ...
    setTimeout(() => {
      setChat((prev) => [
        ...prev,
        {
          id: "assistant-6",
          content:
            "Based on what you've told me, you qualify for a very good discount! Call on the official hotline to claim your discount in just a few minutes  💸",
          role: "assistant",
        },
      ]);
      setIsTyping(false);
    ...
    <>
      <div className="container">
        <div className="header">
          <h1>
          Before You Pay Your Car Insurance Bill This Month, Check This Gov Backed Program in 2025...
          </h1>
        ...
        <div className="button-container">
          ...
          {showOptions && (
            <div className="chat-options" ref={buttonsRef}>
              {/* <button className="chat-button" onClick={handleInsuranceClick}>YES </button>
            <button className="chat-button" onClick={handleMediCare}>NO  </button> */}
          ...
          {showFinalOptions && (
            <div className="chat-options" ref={buttonsRef}>
              ...
              <button className="button1">
                {loading ? (
                  <a href="tel:+16197753027" className="call-button">
                    CALL (619)-7753-027
                  </a>
                ) : error ? (
                  <p>{error}</p>
