    ...
    setTimeout(() => {
      setChat((prev) => [
        ...prev,
        {
          id: "assistant-6",
          content:
            "Based on what you've told me, you might qualify for the $25,000 Final Expense Benefit! Once approved, you'll never have to pay it back 💸",
          role: "assistant",
        },
      ]);
      setIsTyping(false);
      ...
      <div className="container">
        <div className="header">
          <h1>
            ...
            Allowance Benefit Worth $25,000!
          </h1>
